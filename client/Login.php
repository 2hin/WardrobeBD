...
<head>
	...
	?>
				<script>
					alert("Sorry.You Haven't any account ");
				</script>
	<?php
			}
			if($check == 2)
	...
	?>
				<script>
					alert("email has sent & password reset");
				</script>
	<?php
			}
	...
	?>
				<script>
					alert("Pin or email not correct");
				</script>
	<?php
			}
	...
	<div class="container">
		...
		<div class="account_grid">
			   <div class="col-md-6 login-right">
				<form action="Login_data_collector.php" method="post">
					...
					<input type="submit" name="btn_signup" value="Login">
