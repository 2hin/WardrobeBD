				...
				<div class="header-top">
					<div class="container">
							<div class="col-sm-4 logo">
								<h1><a href="home.php">Youth <span>Fashion</span></a></h1>	
							</div>
			...
			<div class="container">
				<div class="register">
					<h2>Register</h2>
						  ...
						  <form action="register_data_collector.php" method="post" onsubmit="return checkForm(this)">
								...
								<div class="mation"> 
								 ...
								 <div class=" col-md-6 register-bottom-grid">
										...
										<div class="mation">
											...
											<span>Password</span>
											<input type="password" name="password" id="password" onkeyup="chkPasswordStrength(this.value,document.getElementById('strendth'),document.getElementById('error'))">
